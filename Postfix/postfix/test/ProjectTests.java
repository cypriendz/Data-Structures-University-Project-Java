...
public class ProjectTests {
	...
	// DivOperator tests
	@Test(timeout = 5000)
	public void testPerformOperationDivOperator() {
	...
	public void testNullArgumentExceptionDivOperator() {
	...
	// MultOperator Tests
	@Test(timeout = 5000)
	public void testPerformOperationMultOperator() {
	...
	// PlusOperator Tests
	@Test(timeout = 5000)
	public void testPerformOperationPlusOperator() {
	...
	public void testIllegalStateExceptionPlusOperator() {
		plusOperator.setOperand(0, op0);
		plusOperator.setOperand(0, op0);
	...
	@Test(timeout = 5000, expected = IllegalStateException.class)
	public void testIllegalStateExceptionPerformPlusOperator() {
	...
	// SubOperator Tests
	@Test(timeout = 500)
	public void testPerformOperationSubOperator() {
	...
	@Test(expected = IllegalPostfixExpressionException.class)
